...
function VouchersPortalPageContent() {
    ...
    <div className="max-w-5xl mx-auto space-y-8">
      <div className="border-b pb-4">
        <h1 className="text-3xl font-extrabold tracking-tight text-neutral-900 dark:text-neutral-50 flex items-center gap-2">
          ...
          <span>Voucher Codes & Promotions</span>
        </h1>
        <p className="mt-1 text-sm text-neutral-500">
          Select an event to create early bird promo codes, fixed/percentage discounts, and track usage redemption limits.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          icon={Tag}
          title="No Events for Vouchers"
          description="Create an event first before configuring promo codes and discount rules."
          action={{
            label: "Create Event",
            ...
            >
              ...
              <CardContent className="pt-2 space-y-4">
                <div className="bg-neutral-50 dark:bg-neutral-800/60 p-3 rounded-xl flex items-center justify-between text-xs text-neutral-600 dark:text-neutral-300 border border-neutral-100 dark:border-neutral-800">
                  <span className="font-semibold">Event Promotion Hub</span>
                  <span className="text-xs text-primary-600 dark:text-primary-400 font-bold">Manage Vouchers &rarr;</span>
                </div>
                ...
                <div className="pt-2 border-t flex justify-end">
                  ...
                  >
                    <Link href={`/dashboard/events/${ev.id}/operations/vouchers`}>
                      Configure Promo Codes <ArrowRight className="h-4 w-4" />
                    </Link>
                  </Button>
                </div>
              </CardContent>
